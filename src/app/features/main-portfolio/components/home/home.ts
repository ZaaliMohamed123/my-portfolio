...
export class Home implements OnInit, AfterViewInit, OnDestroy {
  ...
  techStack: TechStack[] = [
    ...
    { name: 'LangGraph',    key: 'langgraph',    icon: 'assets/media/tech-icons/langgraph.svg',                    color: '#1c3c3c', isCustomIcon: true, scale: 2.5 },
    { name: 'LangFlow',     key: 'langflow',     icon: 'assets/media/tech-icons/langflow.svg',                     color: '#f72585', isCustomIcon: true, scale: 2.5 },
    { name: 'HuggingFace',  key: 'huggingface',  icon: 'assets/media/tech-icons/huggingface.svg',                  color: '#ffbd00', isCustomIcon: true, scale: 2.5 },
    { name: 'FastMCP',      key: 'fastmcp',      icon: 'assets/media/tech-icons/Model_Context_Protocol_logo.svg',  color: '#000000', isCustomIcon: true, scale: 2.5 },
  ];
